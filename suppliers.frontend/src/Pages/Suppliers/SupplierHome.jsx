            ...
            <Container className='content-container'>
                ...
                <Row style={{borderBottom: '2px solid black', paddingBottom: '60px'}}>
                    ...
                    <Col md={5} style={{display: 'flex', flexDirection: 'column', justifyContent: 'center'}}>
                        <h3>Поставщик</h3>
                        <p>Регистрируйтесь в системе в качестве поставщика продуктов питания, ведите учёт предлагаемых товаров, отслеживайте список поступивших заказов партий товаров, формируйте отчётность по торговле</p>
                    </Col>
                </Row>
            </Container>
